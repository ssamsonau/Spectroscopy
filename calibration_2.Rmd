...
* One of the approaches is to take this into account is to do calibration using tungsten lamp
...
* We have SLS201 light source from Thorlabs (with tugsten-halogen bulb inside). 
    - It features a relativelly stable color temperature of 2796 K +/- 15 K
